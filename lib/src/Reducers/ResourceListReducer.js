...
exports.reducer = function (state, action) {
    ...
    switch (action.type) {
        ...
        case ResourceListActionTypes.POST_RESOURCE_SUCCESS: {
            return __assign({}, state, (_c = {}, _c[action.payload.resourceName] = __assign({}, resourceState, { byId: (_d = {},
                    _d[action.payload.resource.id] = action.payload.resource,
                    _d), allIds: resourceState.allIds.concat([action.payload.resource.id]), loading: false, error: undefined }), _c));
        }
